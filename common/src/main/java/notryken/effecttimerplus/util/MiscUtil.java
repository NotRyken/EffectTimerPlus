...
public class MiscUtil {
    ...
    public static int getTimerColor(MobEffectInstance effectInstance) {
        ...
        if (EffectTimerPlus.config().timerWarnEnabled
                && effectInstance.getDuration() != MobEffectInstance.INFINITE_DURATION
                && effectInstance.getDuration() / 20 <= EffectTimerPlus.config().getTimerWarnTime()
                && (!EffectTimerPlus.config().timerFlashEnabled
