...
[![Minecraft](https://img.shields.io/modrinth/game-versions/JIUF2Wb5?label=Minecraft&color=%2300AF5C)](https://modrinth.com/mod/effectinfo/versions)
...
Except where otherwise stated, EffectInfo source files are provided under the terms of the GNU LGPL-3.0-only 
